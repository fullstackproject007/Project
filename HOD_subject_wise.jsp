...
<body class="bg-light">
	...
	try {
		...
		PreparedStatement ps=con.prepareStatement("select student_id,name,year,branch,sub1,sub2,sub3,sub4,sub5 from student where branch=?;");
		String br=session.getAttribute("branch").toString();
		ps.setString(1, br);
				...
				<div class="container-fluid">
					<div class="row height d-flex bg-dark align-items-center justify-content-center">
						<div class="col-md-8 text-center">
							<h2 class="display-4 text-light text-capitalize">-- List of Subject Wise Marks --</h2>
						</div>
					</div>
					<div class="row height-tab d-flex align-items-center justify-content-center py-3 mt-4">
						<div class="col-md-10">
							...
							<tr> <td>Student ID</td><td>Name</td><td>Year</td><td>Branch</td><td>Subject-1</td><td>Subject-2</td><td>Subject-3</td><td>Subject-4</td><td>Subject-5</td> </tr>
							<%
							while(rs.next()){
