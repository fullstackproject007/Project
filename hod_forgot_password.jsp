...
<body>
	<div class="container-fluid py-3 bg-dark">
      <div class="row d-flex justify-content-center">
        <div class="col-md-8">
          <h1 class="display-4 text-light text-center text-capitalize">STUDENT NATION<small><strong>   HOD Forgot Password</strong></small></h1>
        </div>
      </div>
    </div>
    <!--container end-->
      ...
      <div class="container-fluid mt-4 text-dark">
        <div class="row height d-flex justify-content-center align-items-center mt-2">
          <div class="col-lg-5 col-md-6 px-4">
            <form action="HOD_getpassword.jsp" method="post">
              ...
              <div class="form-group">
                <label for="Phone No."><strong>Phone No.</strong></label>
                  <input type="text" name="phoneno" placeholder="Phone No." class="form-control">
              </div>
              <button class="btn btn-warning btn-block btn-sm text-light pt-3 mt-4" type="submit"><h4>Get Password</h4></button>
              <%
			...
			if(session.getAttribute("error")!=null || session.getAttribute("error")=="Wrong Credentials Entered!"){
			  ...
			  %>
			  <div class="mt-3"><a href="Hod_login.jsp" class="text-uppercase text-danger">Login HOD Module</a></div>
            </form>
          </div>
        </div>    
      </div>
