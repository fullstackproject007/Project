...
<title>List Marks Dept. Wise</title>
</head>
<body class="bg-light">
	<%
	...
	<%
	try {
		//Get marks list from hod table in mysql and display it...
		Class.forName("com.mysql.jdbc.Driver");
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root", "Password@007");
		PreparedStatement ps=con.prepareStatement("select student_id,name,year,branch,sub1,sub2,sub3,sub4,sub5,st,pue from student order by branch;");
				...
				<div class="container-fluid">
					<div class="row height d-flex bg-dark align-items-center justify-content-center">
						<div class="col-md-8 text-center">
							<h2 class="display-4 text-light text-capitalize">-- List of Subject Wise Marks All Dept.--</h2>
						</div>
					</div>
					<div class="row height-tab d-flex align-items-center justify-content-center py-3 mt-4">
						<div class="col-md-10">
							<a href="/fs_project/HOD.jsp#info"><h5 class="text-dark font-bold font-italic py-2 text-center">Click here to get back</h5></a>
							<table class="table text-dark table-striped table-light text-center">
							<tr> <td>Student ID</td><td>Name</td><td>Year</td><td>Branch</td><td>Subject-1</td><td>Subject-2</td><td>Subject-3</td><td>Subject-4</td><td>Subject-5</td><td>ST</td><td>PUE</td> </tr>
							<%
							while(rs.next()){
