...
<title>List Marks Year Wise</title>
</head>
<body class="bg-light">
	<%
	...
	try {
		...
		PreparedStatement ps=con.prepareStatement("select student_id,name,year,branch,sub1,sub2,sub3,sub4,sub5,st,pue from student order by year;");
				...
				<div class="container-fluid">
					<div class="row height d-flex bg-dark align-items-center justify-content-center">
						<div class="col-md-8 text-center">
							<h2 class="display-4 text-light text-capitalize">-- List of Marks year wise All Dept.--</h2>
						</div>
					</div>
